...
export default function MonthView() {
  ...
  const [currentYear, setCurrentYear] = useState<string>(dayjs().format('YYYY'));         // format ex. '2020'
  const [monthChange, setMonthChange] = useState<number>(0);    // the offset from the current month
